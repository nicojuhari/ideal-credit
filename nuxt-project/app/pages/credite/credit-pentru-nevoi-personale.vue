...
useHead({
    ...
    meta: [
        ...
        {
            name: "keywords",
            content: "credit pentru nevoi personale, credit rapid, credit de consum, credit Moldova, credit Chișinău, credite nebancare",
        },
    ],
});

useSchemaOrg([personalLoanSchema]);
</script>
<template>
    <div class="relative pt-10 md:pt-12">
        ...
        <div class="container">
            ...
            <h1 class="font-semibold text-center text-4xl md:text-8xl">Credit pentru nevoi personale</h1>
    ...
    <section class="container">
        ...
        <ul class="w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <li v-for="item in creditConditionsSchema.pf.list" class="flex text-xl items-center gap-2 card">
    ...
    <section>
        <div class="container text-lg space-y-4">
            ...
            <p>
                Este un credit de consum destinat persoanelor fizice. Îţi pune la dispoziţie bani rapid, fără destinaţie fixă, pentru orice
                cheltuieli planificate sau neprevăzute.
            </p>
            ...
            <ul class="list-outside list-disc ml-6 text-gray-400">
                ...
                <li>
                    ...
                    <NuxtLink to="/credite/credit-pentru-reparatie" title="Credit pentru reparație" class="link">reparații</NuxtLink>
                </li>
                <li>Familie: vacanțe, nunți, evenimente</li>
                <li>
                    Urgențe: plata facturilor sau
                    <NuxtLink to="/credite/credit-pina-la-salariu" title="Credit pînă la salariu" class="link"
                        >credit pînă la salariu</NuxtLink
                    >
                </li>
            </ul>
