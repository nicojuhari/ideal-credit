...
useHead({
    ...
    meta: [
        ...
        {
            name: "keywords",
            content: "credit pînă la salariu, credit rapid, credit de consum, credit Moldova, credit Chișinău, credite nebancare",
        },
    ],
});
...
<template>
    <div class="relative pt-10 md:pt-12">
        ...
        <div class="container">
            ...
            <h1 class="font-semibold text-center text-4xl md:text-8xl">Credit pînă la salariu</h1>
    ...
    <section class="container">
        ...
        <UiInfo class="mt-6">Dacă lucrezi la același angajator de mai mult timp, aprobarea creditului va fi mult mai rapidă</UiInfo>
    </section>
    <section class="container">
        <LazyHowItWorks />
    </section>
    <section>
        <div class="container text-lg space-y-4">
            ...
            <p>
                Este un credit pe termen scurt destinat persoanelor cu salariu oficial. Îţi oferă bani rapid pentru cheltuieli urgente, până
                primeşti salariul. Nu are destinaţie fixă - foloseşti banii pentru ce ai nevoie..
            </p>
