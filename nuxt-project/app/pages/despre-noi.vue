        ...
        <div class="container">
            <div class="card">
                ...
                <div class="text-lg space-y-4">
                    ...
                    <p>
                        <NuxtLink to="/credite/credit-pentru-afaceri-mici" title="Credit pentru afaceri mici" class="link">Credite pentru afaceri</NuxtLink> - pentru echipamente sau tehnologie, capital de lucru sau refinanțare, modernizare sau extindere.
                    </p>
