...
watch(
    [creditSuma, creditTermen, showModal],
    () => {
    ...
    <div class="relative">
        <div class="card">
            ...
            <div class="grid gap-6 md:gap-10 grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="flex gap-4 justify-between items-center mb-1">
                            ...
                            <label for="credit-amount-input">
                                <input
                                    ...
                                    :value="creditSuma"
                                    @input="validateInput"
                                    @change="validateChange($event.target.value, 'suma')"
                        ...
                        <div class="flex gap-4 justify-between items-center mb-1">
                            ...
                            <label for="credit-period-input">
                                <input
                                    ...
                                    :value="creditTermen"
                                    @input="validateInput"
                                    @change="validateChange($event.target.value, 'termen')"
                                    class="input-calculator"
                                />
                            </label>
                        </div>
                ...
                <div class="space-y-1">
                    <div
                        class="mx-auto w-40 h-40 grid place-content-center gap-2 border-6 border-black-300 bg-black-300/50 rounded-full text-center"
                    >
                        <div class="text-sm">Prima rată</div>
                        <div class="text-brand-500 text-3xl font-semibold">
                            {{ (graficCalculat?.[0]?.credit_rata + graficCalculat?.[0]?.dobinda_rata).toLocaleString() || 0 }}
                        </div>
                        <div class="text-sm">MDL</div>
                    </div>

                    <div class="mt-4 flex justify-center">
                        <UButton color="secondary" variant="subtle" size="sm" @click="showModal = true">Vezi preContractul</UButton>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table-fixsed w-full border-collapse pre-contract-table border" id="preContractTable">
                        <tbody>
                            ...
                            <tr>
                                <td>Adresa</td>
                                <td>
                                    m.Chișinău, str.Miron Costin, nr.25, of.115 (sucursala nr.1)<br /><br />sau<br /><br />or.Căușeni,
                                    str.Mihai Eminescu nr.17, of.47 (sediul principal)
                                </td>
                            </tr>
                            <tr>
                                <td>Nr. Telefon</td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <i class="text-sm"
                                        >Înseamnă plafonul sau sumele totale puse la dispoziţie în temeiul contractului de credit</i
                                    >
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Comisionul pentru prelungirea termenului Contractului este egal cu dobînda necesar a fi achitată pentru
                                    rata care a fost amînată. (La solicitarea clientului)
                                </td>
                            </tr>
                            <tr>
                                <td>Costuri în caz de întîrziere la plată</td>
                                <td>
                                    Se va calcula o penalitate în mărime de 0.04% maxim, pentru fiecare zi de întîrziere din valoarea totală
                                    a creditului
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    ...
                                    contractele de credit pentru consumatori, orice alte plăți aferente creditului acordat (comisioane,
                                    taxe, penalități, dobînzii de întîrziere și orice alt tip de plată), cu excepția dobînzii, se vor încasa
                                    conform regulii ca acestea să nu depășească cumulativ 0,04% din valoarea totală a creditului pe o zi de
                                    credit înmulțit la numărul de zile pentru care este contractat creditul.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    creditul nu a fost eliberat din casierie. Organizația are dreptul la revocarea Contractului dacă
                                    clientul încalcă condițiile acestuia.
                                </td>
                            </tr>
                            <tr>
                                <td>Rambursare anticipată</td>
                                <td>
                                    Clientul are dreptul să ramburseze anticipat creditul. Pentru aceasta, Organizația nu percepe careva
                                    taxe neprecăzute în Contract.
                                </td>
                            </tr>
                            <tr>
                                <td>Consultarea unei baze de date</td>
                                <td>
                                    În cazul în care cererea de solicitare a creditului va fi respinsă, iar temei pentru respingere a
                                    constituit informația vizualizată într-o bază de date, Organizația va informa clientul referitor la baza
                                    de date accesată
                                </td>
                            </tr>
                            <tr>
