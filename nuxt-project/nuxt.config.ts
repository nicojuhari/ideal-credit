...
export default defineNuxtConfig({
    app: {
        head: {
            ...
            meta: [
                ...
                {
                    name: "keywords",
                    content: "credite nebancare, credit md, credit pentru afaceri, credit pentru nevoi personale, credit Chișinău Moldova",
                },
            ...
            script: [{ src: "https://analytics.ahrefs.com/analytics.js", "data-key": "ECFm73uMp/FvsZWP8axloQ", async: true }],
        },
    },
    ...
    routeRules: {
        ...
        "/blog/scorul-de-credit-si-de-ce-conteaza": {
            redirect: { to: "/blog/istoria-de-credit-si-impactul-asupra-finantelor-tale", statusCode: 301 },
        },
        "/credit-pentru-afaceri": { redirect: { to: "/credite/credit-pentru-afaceri-mici", statusCode: 301 } },
        "/credite/credit-pentru-afaceri": { redirect: { to: "/credite/credit-pentru-afaceri-mici", statusCode: 301 } },
