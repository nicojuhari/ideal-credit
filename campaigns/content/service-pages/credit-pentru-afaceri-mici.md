...
*Note: keep the amount range in the hero. Competitors hide it; stating it filters out
the wrong traffic before it costs staff time — and it is the cheapest expression of
the "creditorul care spune și nu" angle.*

### Pentru ce poți folosi creditul
*(situations, not product names — this is the "soluții, nu produse" angle in practice)*
...
*Note: that closing box is the "creditorul care spune și nu" angle, delivered warmly.
It must read as respect for the client's time, never as gatekeeping.*
...
*Note: this honest-disadvantage block is a trust asset. No competitor publishes the
case for going to a bank instead. Do not soften it.*
...
*Note: "ce NU ți se cere" is the strongest differentiator on the page. No competitor
states it. Keep it on every service page.*
