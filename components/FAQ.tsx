                            ...
                            <Accordion className="w-full">
                                {filtered.map((item, i) => (
                                    <AccordionItem key={item.question} value={`item-${i}`} className="border-white/5">
                                        ...
                                        <AccordionContent className=" text-sm md:text-base leading-relaxed pb-5">
                                            {item.answer}
                                        </AccordionContent>
                                    </AccordionItem>
                                ))}
            ...
            <div className="mt-6 rounded-xl border border-white/5 bg-black-600/70 p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm mt-0.5">Scrie-ne, îți răspundem într-un timp scurt și te ghidăm pas cu pas.</p>
                    </div>
                </div>
                <Link
                    href="/contacte"
