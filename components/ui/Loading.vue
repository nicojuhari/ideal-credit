...
<template>
    <div class="bg-black bg-opacity-60 flex w-full h-full top-0 left-0" :class="local ? 'absolute' : 'fixed z-[60]'">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="relative m-auto" :class="class">
