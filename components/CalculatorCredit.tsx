...
export default function CalculatorCredit() {
 ...
 <span className="text-[11px] uppercase tracking-wider">4% lunar</span>
 </div>
 ...
 <AnimatedNumber value={primaRata} /> <span className="text-base font-normal">MDL</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <label htmlFor="credit-amount-input" className="text-sm">
 Suma
 </label>
 ...
 <div className="mb-6">
 <div className="flex items-center justify-between mb-2">
 <label htmlFor="credit-period-input" className="text-sm">
 Termen
 </label>
 <div className="flex items-center gap-1 text-white">
 <div className="input-calculator flex items-center justify-end">{creditTermen}</div>
 <span className="text-sm">luni</span>
 </div>
 </div>
 <GradientSlider
 ...
 <div className="text-[11px] uppercase tracking-wider">DAE</div>
 <div className="text-sm font-semibold tabular-nums">{dae} %</div>
 </div>
 <div className="rounded-lg bg-black-400 px-3 py-2">
 <div className="text-[11px] uppercase tracking-wider">Cost total</div>
