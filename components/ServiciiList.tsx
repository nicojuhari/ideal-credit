...
function ProductCard({ product }: { product: Product }) {
 ...
 <span className="mt-0.5 text-sm leading-snug">{product.desc}</span>
 </span>
 </Link>
 );
}
...
export default function ServiciiList() {
 ...
 {/* Business */}
 <div>
 <h3 className="text-xs uppercase tracking-widest font-medium mb-3 px-1">Pentru afaceri</h3>
 ...
 {/* Personal */}
 <div>
 <h3 className="text-xs uppercase tracking-widest font-medium mb-3 px-1">Pentru persoane fizice</h3>
 <div className="space-y-2">
