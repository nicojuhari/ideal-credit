        ...
        <footer className="bg-black-600 border-t relative py-10">
            ...
            <div className="container flex flex-col md:flex-row justify-between md:items-center gap-8 pb-8 border-b">
                ...
                <div className="flex gap-6 items-center">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="#fff" viewBox="0 0 256 256">
            ...
            <div className="container py-8 grid grid-cols-1 md:grid-cols-3 gap-8 gap-y-12 border-b">
                ...
                <div className="flex flex-col gap-y-4">
                    ...
                    <Link href="/terms" title="Termeni și Condiții" className="inline-flex hover:text-white/70 transition-colors">
                        Termeni
                    </Link>
                    <Link href="/cookies" title="Politica de Cookies" className="inline-flex hover:text-white/70 transition-colors">
                        Cookies
                    </Link>
                    <Link
                        href="/privacy"
                        title="Politica de Confidențialitate"
                        className="inline-flex hover:text-white/70 transition-colors"
                    >
                        Confidențialitate
                    </Link>
                    <Link
                        href="/autoritatea-de-supraveghere"
                        rel="nofollow"
