...
const cls = 'rounded-lg flex-col inline-flex gap-4 items-center p-6 md:py-8- aspect-square md:aspect-auto justify-center hover:scale-105 transition-all duration-300'
</script>
...
<template>
    <div class="grid grid-cols-1 md:grid-cols-2 md:gap-6 items-center">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <a :href="viberUrl" :class="cls" class="text-[#7360f2] bg-[#7360f2]/20"
