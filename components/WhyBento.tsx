...
export default function WhyBento() {
 ...
 <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/3 px-3 py-1 text-xs">
 ...
 <p className="mt-1 text-sm leading-relaxed">{cell.body}</p>
 </motion.div>
 );
 })}
 </div>
