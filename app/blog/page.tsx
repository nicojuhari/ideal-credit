    ...
    return (
        ...
        >
            <div className="flex items-center justify-between">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/3 px-3 py-1 text-xs text-gray-500">
                    <Icon size={11} />
            ...
            <p className="text-sm text-gray-500 leading-relaxed line-clamp-3 flex-1">{post.description}</p>
    ...
    return (
        <div className="container my-8 md:my-12">
            ...
            {blogPosts.length > 0 ? (
                ...
                <p className="text-center text-gray-500 py-20">Articolele se publică în curând.</p>
            )}
        </div>
    );
}
