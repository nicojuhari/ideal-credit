    ...
    return (
        <div className="py-8 md:py-12">
            <div className="container sm-container">
                {/* Back link */}
                <Link href="/blog" className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-white transition-colors mb-8">
                    ← Înapoi la blog
                </Link>
                ...
                <div className="mt-12 rounded-2xl border border-brand-500/20 bg-black-600/60 p-7 relative overflow-hidden">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-xl">
                        Articolele explică principii generale. Situația ta poate fi diferită. Consultăm gratuit — fără angajamente, fără presiuni.
                        Dacă există o soluție potrivită pentru tine, o găsim împreună.
                    </p>
