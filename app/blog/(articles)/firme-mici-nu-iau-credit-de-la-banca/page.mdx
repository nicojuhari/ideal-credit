...
export const metadata = {
    title: "Nouă din zece firme mici nu iau credit de la bancă | Dincolo de Cifre",
    description:
...
<Caption className="mt-6">
  Notă: datele despre sursele de finanțare ale firmelor mici (secțiunea „Cifrele”) sunt verificate direct din raportul Enterprise Surveys al Băncii Mondiale, Moldova 2024. Cifrele despre piața bancară și sectorul de creditare nebancară vin din presa economică, nu direct de la BNM sau CNPF, și e posibil să amestece creditele pentru companii cu cele pentru persoane fizice - le tratăm ca estimări, nu ca cifre exacte.
</Caption>
