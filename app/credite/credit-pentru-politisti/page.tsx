...
export const metadata: Metadata = {
  ...
  description: 'Credit pentru polițiști — împrumut personal pentru angajați și pensionari MAI din Moldova. Aprobat rapid, rate fixe și fără comisioane ascunse.',
    ...
    <>
      <div className="relative pt-10 md:pt-12">
        ...
        <div className="container">
          ...
          <h1 className="font-semibold text-center text-5xl md:text-8xl" dangerouslySetInnerHTML={{ __html: 'Credit pentru polițiști' }} />
          <p className="text-center mt-6 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">Credit pentru polițiști sau pensionari MAI din Republica Moldova - bani pentru urgențe și cheltuieli personale.</p>
      ...
      <section className="container">
        ...
        <ul className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {["Vârsta între 23 și 65 ani", "Angajat (minim 12 luni) sau pensionar MAI", "Buletin de identitate valabil", "Fără datorii la alte credite"].map((item) => (
