...
export const metadata: Metadata = {
  ...
  description: 'Credit pînă la salariu pentru persoanele angajate oficial și cu venit constant. Aprobare rapidă, dobânzi avantajoase și transparență totală. Aplică online!',
    ...
    <>
      ...
      <div className="relative pt-10 md:pt-12">
        ...
        <div className="container">
          ...
          <h1 className="font-semibold text-center text-5xl md:text-8xl" dangerouslySetInnerHTML={{ __html: 'Credit pînă la salariu' }} />
          <p className="text-center mt-6 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">Oferim credit pînă la salariu pentru persoanele angajate oficial. Soluția perfectă pentru cheltuieli neprevăzute.</p>
      ...
      <section className="container">
        ...
        <ul className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {["Vârsta de la 23 de ani", "Salariu oficial stabil", "Buletin de identitate valabil", "Responsabilitate financiară"].map((item) => (
      ...
      <section>
        <div className="container text-lg space-y-4">
          ...
          <p>Este un credit pe termen scurt destinat persoanelor cu salariu oficial. Îţi oferă bani rapid pentru cheltuieli urgente, până primeşti salariul.</p>
