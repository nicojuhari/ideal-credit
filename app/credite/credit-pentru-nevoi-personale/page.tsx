...
export const metadata: Metadata = {
  ...
  description: 'Credit pentru nevoi personale în Moldova cu dobânda fixă. Obține un credit pentru cheltuieli urgente, pînă la salariu sau planuri personale. Aplică Online!',
    ...
    <>
      ...
      <div className="relative pt-10 md:pt-12">
        ...
        <div className="container">
          ...
          <p className="text-center mt-6 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">Obține un credit pentru nevoi personale rapid și ușor, perfect pentru cheltuieli urgente sau proiecte mici.</p>
      ...
      <section>
        <div className="container text-lg space-y-4">
          ...
          <ul className="list-outside list-disc ml-6 text-gray-400">
            ...
            <li>Locuință: renovări mici, <Link href="/credite/credit-pentru-reparatie" title="Credit pentru reparație" className="link">reparații</Link></li>
            <li>Familie: vacanțe, nunți, evenimente</li>
            <li>Urgențe: plata facturilor sau <Link href="/credite/credit-pina-la-salariu" title="Credit pînă la salariu" className="link">credit pînă la salariu</Link></li>
          </ul>
