...
export const metadata: Metadata = {
  ...
  description: 'Credit pentru agricultură - finanțare pentru tehnică, semințe, îngrășăminte, pesticide și lucrări agricole. Condiții simple și transparente!',
    ...
    <>
      ...
      <div className="relative pt-10 md:pt-12">
        ...
        <div className="container">
          ...
          <h1 className="font-semibold text-center text-5xl md:text-8xl" dangerouslySetInnerHTML={{ __html: 'Credit pentru<br />agricultură' }} />
          <p className="text-center mt-6 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">Credit pentru agricultură - tehnică, semințe, îngrășăminte, pesticide și lucrări agricole. Proces simplu și transparent.</p>
      ...
      <section>
        <div className="container text-lg space-y-4">
          ...
          <p>Este un împrumut pentru fermieri și companii agricole (SRL, ÎI) care au nevoie de capital pentru cumpărarea tehnicii agricole sau achiziția de inputuri.</p>
