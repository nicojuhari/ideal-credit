...
export const metadata: Metadata = {
  ...
  description:
    "Credite nebancare pentru afaceri și persoane fizice în Moldova. Capital de lucru, investiții, refinanțare, credit personal - dobândă fixă, aprobare în 1-3 ore.",
...
const hubFaqItems: FaqItem[] = [
  {
    ...
    answer: "Un credit nebancar este acordat de o instituție financiară nebancară (IFN), autorizată și supravegheată de CNPF. Principala diferență față de bănci: procesul de aprobare este mai rapid (1-3 ore față de zile sau săptămâni), documentația este mai simplă și evaluarea este mai flexibilă - acceptăm clienți refuzați de bănci.",
  },
  {
    question: "Cât timp durează aprobarea unui credit?",
    answer: "Pentru dosarele complete depuse în programul de lucru, răspundem în 1-3 ore. Dacă documentele sunt în regulă, fondurile pot fi disponibile în aceeași zi.",
  },
  {
  ...
  return (
    <>
      <section className="container pt-10 md:pt-12">
        ...
        <p className="text-center mt-4 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">
          Finanțare pentru afaceri și persoane fizice. Dobândă fixă, costuri clare, decizie în 1-3 ore.
        </p>
