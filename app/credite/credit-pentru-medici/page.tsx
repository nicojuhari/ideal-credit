...
export const metadata: Metadata = {
  ...
  description: 'Credit pentru medici — condiții speciale, dobânzi avantajoase și aprobare rapidă. Soluții transparente pentru medicii din Republica Moldova. Aplică online!',
    ...
    <>
      ...
      <div className="relative pt-10 md:pt-12">
        ...
        <div className="container">
          ...
          <h1 className="font-semibold text-center text-5xl md:text-8xl" dangerouslySetInnerHTML={{ __html: 'Credit pentru medici' }} />
          <p className="text-center mt-6 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">Credit pentru medici - împrumut personal cu rată adaptată și rambursare ușoară pentru cheltuieli personale sau urgente.</p>
      ...
      <section className="container">
        ...
        <ul className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {["Vârsta între 23 și 55 ani", "Angajat oficial, minim 24 de luni", "Buletin de identitate valabil", "Fără restanțe la alte credite"].map((item) => (
