...
export const metadata: Metadata = {
  ...
  description: 'Credit pentru cumpărarea sau repararea automobilului. Obține rapid banii necesari, cu dobândă fixă și condiții transparente. Aplică online!',
    ...
    <>
      <div className="relative pt-10 md:pt-12">
        ...
        <div className="container">
          ...
          <h1 className="font-semibold text-center text-5xl md:text-8xl" dangerouslySetInnerHTML={{ __html: 'Credit pentru automobil' }} />
          <p className="text-center mt-6 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">Cumpără sau repară mașina fără complicații. Finanțare rapidă, condiții clare și dobândă fixă.</p>
      ...
      <section className="container">
        ...
        <ul className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {["Vârsta între 23 și 55 de ani", "Venit confirmat și stabil", "Buletin de identitate valabil", "Responsabilitate financiară"].map((item) => (
      ...
      <section>
        <div className="container text-lg space-y-4">
          ...
          <p>Credit destinat achiziției, reparației sau modernizării unui automobil. Îți oferă rapid bani pentru cumpărarea unei mașini noi sau second-hand, reparații tehnice sau accesorii.</p>
