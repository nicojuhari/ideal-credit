...
export const metadata: Metadata = {
    ...
    description:
        "Credit capital de lucru pentru SRL și ÎI din Moldova. Acoperiți salarii, furnizori și stocuri - până la 400.000 lei, decizie în 1-3 ore.",
...
const comparisonRows = [
    { label: "Viteză aprobare", ifn: "1-3 ore", bank: "1-5 zile lucrătoare" },
            ...
            <div className="relative pt-10 md:pt-12">
                ...
                <div className="container">
                    ...
                    <h1
                        ...
                        dangerouslySetInnerHTML={{ __html: "Credit capital<br />de lucru" }}
                    />
                    <p className="text-center mt-6 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">
                        Menții activitatea firmei când încasările întârzie.
                        Fără birocrație, fără așteptări săptămâni întregi.
                    </p>
                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b border-white/5 bg-black-600/80">
                                <th className="text-left px-5 py-3.5 text-white/40 font-medium w-1/3"></th>
                                <th className="px-5 py-3.5 text-brand-500 font-semibold text-center">Ideal Credit (IFN)</th>
                                <th className="px-5 py-3.5 text-white/40 font-medium text-center">Descoperit cont bancar</th>
                            </tr>
                        </thead>
                        <tbody className="bg-black-600/40">
                            {comparisonRows.map((row, i) => (
                                <tr key={row.label} className={i < comparisonRows.length - 1 ? "border-b border-white/5" : ""}>
                                    ...
                                    <td className="px-5 py-4 text-white/40 text-center">{row.bank}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                ...
                <div className="rounded-2xl border border-white/5 bg-black-600/50 p-8 md:p-10 text-center flex flex-col items-center gap-6">
                    <div>
                        ...
                        <p className="text-white/55 text-sm md:text-base max-w-md mx-auto">
                            Cerere online în 5 minute. Decizie în 1-3 ore. Banii în cont în aceeași zi.
                        </p>
                    </div>
