...
export const metadata: Metadata = {
  ...
  keywords:
    "credite nebancare, credit md, credit pentru afaceri, credit pentru nevoi personale, credit Chișinău Moldova",
  openGraph: {
    locale: "ro_MD",
    type: "website",
    ...
    <html lang="ro-MD">
      <head>
        ...
        <Script
          ...
          data-key="ECFm73uMp/FvsZWP8axloQ"
