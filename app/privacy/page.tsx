  ...
  return (
    <div className="container my-6">
      <div className="card space-y-4 text-lg">
        ...
        <p>
          OCN Ideal Credit SRL, cu sediul principal în or.Căușeni, str.Mihai Eminescu nr.17, of.47, Republica Moldova, se angajează
          să protejeze confidențialitatea datelor dumneavoastră personale.
        </p>
        ...
        <p>
          ...
          <a href="mailto:info@idealcredit.md" className="link">info@idealcredit.md</a>.
        </p>
        ...
        <p className="mt-8 text-gray-400">
          Această Politică de Confidențialitate a fost actualizată ultima dată la 26.07.2024.
        </p>
      </div>
    </div>
  );
