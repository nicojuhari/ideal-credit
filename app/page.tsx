...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <section className="container mt-18 md:mt-26">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 mb-8">
                        {latestPosts.map((post) => (
                            ...
                            >
                                ...
                                <p className="text-sm font-medium text-white leading-snug group-hover:text-brand-500 transition-colors line-clamp-2">
                                    {post.title}
                                </p>
                                <p className="text-xs leading-relaxed line-clamp-2 flex-1">{post.description}</p>
