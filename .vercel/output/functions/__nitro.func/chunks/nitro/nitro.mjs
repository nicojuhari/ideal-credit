...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2025-03-26T16:57:13.597Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2025-03-26T16:57:13.597Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "dba9b171-0ae5-4f1d-8bb4-61b425612bbf",
  ...
  "siteUrl": "https://idealcredit.md",
  "icm_api_url": "http://localhost:3000/api",
  "secret_key": "gCg6DcOKzfdvCmUgSN2YI5atWA5MQ2nY",
  "storyblok_mode": "",
  "icon": {
  ...
  "nuxt-robots": {
    ...
    "groups": [
      {
        ...
        "_rules": [
          ...
          {
            "pattern": "/autoritatea-de-supraveghere",
            "allow": false
          },
          {
            "pattern": "/",
    ...
    "sitemap": [
      "https://idealcredit.md/sitemap.xml",
      "/sitemap.xml"
    ],
    "header": true,
...
const _gLGc40GGSP7RivfGa7ILdjOeYOeatS0o5Fd7zN1HTQ = defineNitroPlugin(async (nitroApp) => {
...
const _0S9fR3XIhFrrDwG2h3wfrCHVcpcs4vNaRcZSJnfmTE = defineNitroPlugin(async (nitroApp) => {
...
const _Uujo4GS3mKe3vNaG7ZOcipcvFhsPlPsJhOvAdYB4w = defineNitroPlugin(async (nitro) => {
  return;
});

const plugins = [
  _gLGc40GGSP7RivfGa7ILdjOeYOeatS0o5Fd7zN1HTQ,
_0S9fR3XIhFrrDwG2h3wfrCHVcpcs4vNaRcZSJnfmTE,
_Uujo4GS3mKe3vNaG7ZOcipcvFhsPlPsJhOvAdYB4w
];
...
const _gEfJiW = defineCachedEventHandler(async (event) => {
...
const _sfesbB = defineEventHandler(async (e) => {
...
const _rM1Flg = defineEventHandler(async (e) => {
...
const _HUJ_92 = defineEventHandler(async (e) => {
...
const _wPaXSg = defineEventHandler(async (e) => {
...
const _1hxTb0 = defineEventHandler(async (e) => {
...
const _lazy_UjAz_G = () => import('../routes/api/__sitemap__/urls.mjs');
const _lazy_on3ntE = () => import('../routes/api/cerere-online.post.mjs');
const _lazy_06_vgY = () => import('../routes/renderer.mjs').then(function (n) { return n.b; });
const _lazy_7p_B8f = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_50f46j = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/__sitemap__/urls', handler: _lazy_UjAz_G, lazy: true, middleware: false, method: undefined },
  { route: '/api/cerere-online', handler: _lazy_on3ntE, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_06_vgY, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _gEfJiW, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _sfesbB, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _rM1Flg, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _HUJ_92, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _wPaXSg, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _1hxTb0, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_7p_B8f, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_50f46j, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_50f46j, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_06_vgY, lazy: true, middleware: false, method: undefined }
];
...
export { stringifyQuery as $, setHeader as A, hash$1 as B, parseURL as C, setResponseHeader as D, proxyRequest as E, sendRedirect as F, resolveContext as G, H3Error as H, createHooks as I, getContext as J, toRouteMatcher as K, createRouter$1 as L, defu as M, hasProtocol as N, joinURL as O, withQuery as P, sanitizeStatusCode as Q, isScriptProtocol as R, executeAsync as S, withoutTrailingSlash as T, titleCase as U, withLeadingSlash as V, withBase as W, camelCase as X, withoutBase as Y, defuFn as Z, klona as _, asSitemapUrl as a, parseQuery as a0, serialize$1 as a1, isEqual as a2, decodeHtml as a3, logger as a4, toBase64Image as a5, htmlDecodeQuotes as a6, sendError as a7, fontCache as a8, listener as a9, defineEventHandler as b, buildAssetsURL as c, defineSitemapEventHandler as d, getResponseStatus as e, defineRenderHandler as f, getResponseStatusText as g, getQuery as h, createError$1 as i, getRouteRules as j, useNitroApp as k, destr as l, prefixStorage as m, useStorage as n, useNitroOrigin as o, publicAssetsURL as p, emojiCache as q, readBody as r, useOgImageRuntimeConfig as s, fetchIsland as t, useRuntimeConfig as u, normaliseFontInput as v, theme as w, withTrailingSlash as x, handleCacheHeaders as y, setHeaders as z };
