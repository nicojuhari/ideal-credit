...
<template>
    <div class="relative pt-10 md:pt-12">
        ...
        <div class="container">
            ...
            <h1 class="font-semibold text-center text-4xl md:text-8xl">Credit până la salariu</h1>
            <p class="text-center mt-6 px-4 md:px-0 text-gray-400 md:text-xl md:max-w-xl mx-auto text-lg font-light">Oferim credit până la salariu pentru persoanele angajate oficial. Soluția perfectă pentru cheltuieli neprevăzute.</p>
    ...
    <section>
        <div class="container text-lg space-y-4">
            <h2 class="card-title text-center">Ce este un credit până la salariu?</h2>
           ...
           <!-- <UiInfo class="mt-10">Important: Dacă lucrezi la același angajator de mai mult timp, aprobarea creditului va fi mult mai rapidă.</UiInfo> -->
        </div>
